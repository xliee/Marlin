...
#define STRING_CONFIG_H_AUTHOR "Xliee" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "X-KLP"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "b9f7036d-b275-4087-9c77-222d73cb4dd3"
...
#define DELTA
  ...
  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
    ...
    #define PRINTABLE_RADIUS     118    // (mm)
  #else
  ...
  #define DELTA_HEIGHT 275.63             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.517, -0.883, 0.0 } // (mm) Get these values from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.526, -0.347, -0.179 } // (mm) Get these values from G33 auto calibrate
